...
async def status(ctx):
    ...
    e.add_field(name = 'Версия', value = 'b10.2.0', inline = True)
...
@commands.cooldown(1, 15, commands.BucketType.user)
async def about(ctx):
    emb = discord.Embed(title = "Бета 10.2.0 от 01.07.2021 20:44 MSK", color = 0x000000)
    fixed = "ㆍУдалены нерабочие теги из подсказки команды `!!nsfw`."
