...
async def status(ctx):
    ...
    e.add_field(name = 'Версия', value = 'b10.2.4', inline = True)
...
@commands.cooldown(1, 15, commands.BucketType.user)
async def about(ctx):
    emb = discord.Embed(title = "Бета 10.2.4 от 07.07.2021 17:28 MSK", color = 0x000000)
    fixed = "ㆍИсправления мелких ошибок."
    improved = "ㆍСнижена задержка на большинство команд."
    added = "ㆍТеперь бот может воспрозводить музыку в трибунах."
