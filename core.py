...
async def status(ctx):
    ...
    e.add_field(name = 'Версия', value = 'b10.2.3', inline = True)
...
@commands.cooldown(1, 15, commands.BucketType.user)
async def about(ctx):
    emb = discord.Embed(title = "Бета 10.2.3 от 05.07.2021 18:00 MSK", color = 0x000000)
    fixed = "ㆍИсправлено преобразование времени в командах `!!mute` и `!!timer`."
