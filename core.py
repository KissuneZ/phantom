...
async def status(ctx):
    ...
    e.add_field(name = 'Версия', value = 'b9.9.8.6', inline = True)
...
@commands.cooldown(1, 15, commands.BucketType.user)
async def about(ctx):
    emb = discord.Embed(title = "Бета 9.9.8.6 от 28.06.2021 09:37 MSK", color = 0x000000)
    fixed = "ㆍКоманда `!!unban` теперь работает.\nㆍОбход использования упоминаний при выполнении `!!say` теперь невозможен."
    ...
    added = "ㆍДобавлена команда `!!about`. С её помощью вы сможете узнать о последних изменениях в боте."
