...
async def status(ctx):
    ...
    e.add_field(name = 'Версия', value = 'b9.9.9.3', inline = True)
...
@commands.cooldown(1, 15, commands.BucketType.user)
async def about(ctx):
    emb = discord.Embed(title = "Бета 9.9.9.3 от 28.06.2021 17:51 MSK", color = 0x000000)
    ...
    added = "ㆍБот автоматически покидает голосовой канал, если в нем никого нет."
